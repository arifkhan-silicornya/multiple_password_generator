...
form.addEventListener('submit', e => {
  e.preventDefault()
  passWordArray = []
  for (let index = 0; index < PasswordAmountNumber.value; index++) {
    passWordArray.push(passGenerator())
  }
  passwordDisplay.innerText = passWordArray.length + " Password Generated and saved as docs";
  
  
  const textToBLOB = new Blob([passWordArray], { type: 'text/plain' });
  
  const sFileName = 'password.docs';
